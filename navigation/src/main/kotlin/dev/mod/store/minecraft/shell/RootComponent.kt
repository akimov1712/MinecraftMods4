...
import dev.mod.store.minecraft.feature.ignition.CurtainComponent
...
/**
 * Top of the component tree. Drives the root stack: Ignition (splash) → Hub (tabs), with an
 * optional full-screen promo (Curtain) in between, and Search, Spotlight, Loadout, Outreach
 * and Walkthrough pushed on top.
 */
interface RootComponent {
    ...
    sealed interface Child {
        ...
        data class Curtain(val component: CurtainComponent) : Child
